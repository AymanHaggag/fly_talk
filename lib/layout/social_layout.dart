    ...
    return BlocConsumer<SocialCubit, SocialStates>(
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
             ...
             leading: state is UserGetUserLoadingState ?
              IconButton(
              onPressed: (){
        Navigator.push(context, MaterialPageRoute(builder: (context)=>ProfileScreen()));
          ...
          body: SocialCubit.get(context).screensList[SocialCubit.get(context).currentIndex],
            ...
            child: BottomNavigationBar(
              ...
              onTap: (index) {
                if(SocialCubit.get(context).currentIndex == 1){
                  if(SocialCubit.get(context).allUsersList.isEmpty){
